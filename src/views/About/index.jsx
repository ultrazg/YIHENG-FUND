...
import a3URL from '../../images/a3.jpg';
    ...
    return (
      <div>
        <div className="about-layout container">
          ...
          <div className="aboutImgs row">
            <div className="col-md-4">
              <img className="img-responsive" src={a1URL} alt=""/>
            </div>
            <div className="col-md-4">
              <img className="img-responsive" src={a2URL} alt=""/>
            </div>
            <div className="col-md-4">
              <img className="img-responsive" src={a3URL} alt=""/>
            </div>
          </div>
        </div>
        <Footer/>
